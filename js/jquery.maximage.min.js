            ...
            var i = {
                setup: function() {
                    if (a.Slides.length > 0) {
                        ...
                        for (r = 0; r < p; r++) {
                            var q = a.Slides[r];
                            m.append('<div class="mc-image ' + q.theclass + '" title="' + q.alt + '" style="background-image:url(\'' + q.url + "');" + q.style + '" data-href="' + q.datahref + '">' + q.content + "<div class='nav-counter'>0"+(r+1)+" / 0"+p+"</div></div>")
                        }
                        i.preload(0);
                        i.resize()
                    }
